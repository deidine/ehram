  ...
  return (
    <div className="flex flex-col items-center  gap-4 min-h-screen bg-gray-100">
      ...
      <div className="space-x-4">
        <Link href="/register" className="text-lg text-white bg-gray-500 hover:bg-gray-600 px-6 py-2 rounded-lg">
           
            الإنتـســــاب
       
        </Link>
        <Link href="/login" className="text-lg text-white bg-gray-500 hover:bg-gray-600 px-6 py-2 rounded-lg">
